				...
				<tbody>
					<c:forEach var="event" items="${eventList}">
						<tr>
							...
							<td><a
								href="/app/admin/approveevent.htm?eventId=${event.getEventId()}"
								class="btn see-more-btn">Approve</a></td>
							<td><a
								href="/app/admin/cancelevent.htm?eventId=${event.getEventId()}"
								class="btn see-more-btn">Cancel</a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
