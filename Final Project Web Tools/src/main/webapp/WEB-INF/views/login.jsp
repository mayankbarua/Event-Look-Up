				...
				<div class="col-12 col-lg-8">
					<div class="login-content">
						...
						<div class="login-form">
							<form:form action="/app/login.htm" method="post" commandName="user">
								<div class="form-group">
									<label for="exampleInputEmail1">Email address</label> <form:input path="userEmail"
							...
							<br>
							<form action="/app/createevent.htm">
								<button type="submit" class="btn btn-link">Create Event</button>
							</form>
							<form action="/app/registeruser.htm">
								<button type="submit" class="btn btn-link">Don't have
									Account ! Click Here</button>
							</form>
